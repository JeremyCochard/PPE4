...
public class ConsultationReservation extends AppCompatActivity {
    ...
    private Button button_pageMenuUtilisateur, button_demande_reservation, button_historique_reservation, buttonConsultation;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        button_pageMenuUtilisateur.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                PageAccueilConnexion = new Intent(ConsultationReservation.this, MenuUtilisateur.class);
